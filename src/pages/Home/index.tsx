    ...
    const sections = [
        {
            ...
            description: '主要な分野や特長など、\n展示会の実績紹介と\nマーケティング支援',
            images: ['/images/exhibition1.jpg', '/images/exhibition2.jpg', '/images/exhibition3.jpg', '/images/exhibition4.jpg']
        },
        {
            title: '焼酎/日本酒 クラフトビール フェス',
            subtitle: 'Shochu & SAKE Craft Beer Fes',
            description: '全国の酒蔵さんが勢揃い！\n地元とは異なる\n新たな日本酒と\n各フェスを開催！',
            images: ['/images/sake1.jpg', '/images/sake2.jpg', '/images/sake3.jpg', '/images/sake4.jpg']
        },
        {
                ...
                {sections.map((section, index) => (
                    <section key={index} className="relative">
                        <div className="mb-6">
                            ...
                            <p className="whitespace-pre-line text-gray-600">{section.description}</p>
                        </div>
